...
OdeeoSdkManagerListener* _odeeoSdkSetOnInitializationListener(POTypeCallbackClientRef * listener,
                                                              OdeeoSdkVoidDelegateNative onInitializationSuccess,
                                                              OdeeoSdkVoidDelegateNative onInitializationFailed)
{
...
// GDPR
void _odeeoSdkSetGdprConsentString(const char* consentString){
    [Odeeo setGdprConsentString:GetStringParam(consentString)];
}

void _odeeoSdkSetGdprConsent(bool consent){
    [Odeeo setGdprConsent:consent];
}

void _odeeoSdkSetGdprConsentWithString(bool consent, const char* consentString){
    [Odeeo setGdprConsent:consent withConsentString:GetStringParam(consentString)];
}
...
OdeeoSdkAdListener* _odeeoSdkSetListeners(AdUnit* ad,
                                      ...
                                      OdeeoSdkNoArgsDelegateNative onMute)
{
