...
public class VFXSpawnController : SingletonDontDestroy<VFXSpawnController>
{
    ...
    public GameObject SpawnVFX(VisualEffectType visualEffectType, Vector3 position, Color? color = null,
    ...
    public GameObject SpawnVFX(VisualEffectType visualEffectType, Vector3 position, Transform parent,
        Color? color = null,
