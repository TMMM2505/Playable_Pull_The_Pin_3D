...
namespace Lean.Common
{
	...
	public class LeanPlane : MonoBehaviour
	{
		...
		public Vector3 GetClosest([Bridge.Ref] Ray ray, float offset = 0.0f)
		{
			var normal   = transform.forward;
			var point    = transform.position + normal * offset;
			var distance = default(float);
		...
		private static bool RayToPlane([Bridge.Ref] Vector3 point, [Bridge.Ref] Vector3 normal, [Bridge.Ref] Ray ray, ref float distance)
		{
