...
namespace Lean.Common
{
	...
	public class LeanPath : MonoBehaviour
	{
		...
		public void SetLine([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b)
		{
			if (Points == null)
			{
		...
		public bool TryGetClosest([Bridge.Ref] Vector3 position, ref Vector3 closestPoint, ref int closestIndexA, ref int closestIndexB, int smoothing = -1)
		{
		...
		public bool TryGetClosest([Bridge.Ref] Vector3 position, ref Vector3 closestPoint, int smoothing = -1)
		{
		...
		public bool TryGetClosest([Bridge.Ref] Ray ray, ref Vector3 closestPoint, ref int closestIndexA, ref int closestIndexB, int smoothing = -1)
		{
			var count = GetPointCount(smoothing);
		...
		public bool TryGetClosest([Bridge.Ref] Ray ray, ref Vector3 currentPoint, int smoothing = -1)
		{
			var closestIndexA = default(int);
			var closestIndexB = default(int);
		...
		public bool TryGetClosest([Bridge.Ref] Ray ray, ref Vector3 currentPoint, int smoothing = -1, float maximumDelta = -1.0f)
		{
		...
		private Vector3 GetClosestPoint([Bridge.Ref] Vector3 position, [Bridge.Ref] Vector3 origin, [Bridge.Ref] Vector3 direction)
		{
		...
		private Vector3 GetClosestPoint([Bridge.Ref] Ray ray, [Bridge.Ref] Vector3 origin, [Bridge.Ref] Vector3 direction)
		{
		...
		private float GetClosestDistance([Bridge.Ref] Ray ray, [Bridge.Ref] Vector3 point)
		{
