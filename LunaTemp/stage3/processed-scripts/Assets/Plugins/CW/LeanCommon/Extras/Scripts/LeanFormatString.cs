...
namespace Lean.Common
{
	...
	public class LeanFormatString : MonoBehaviour
	{
		...
		/// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
		public void SetString([Bridge.Ref] Vector2 a)
		{
			SendString(a);
		}

		/// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
		public void SetString([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b)
		{
			SendString(a, b);
		}

		/// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
		public void SetString([Bridge.Ref] Vector3 a)
		{
			SendString(a);
		}

		/// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
		public void SetString([Bridge.Ref] Vector3 a, [Bridge.Ref] Vector3 b)
		{
			SendString(a, b);
		}

		/// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
		public void SetString([Bridge.Ref] Vector4 a)
		{
			SendString(a);
		}

		/// <summary>This method will convert the input arguments into a formatted string, and output it to the <b>OnString</b> event.</summary>
		public void SetString([Bridge.Ref] Vector4 a, [Bridge.Ref] Vector4 b)
		{
			SendString(a, b);
		}
