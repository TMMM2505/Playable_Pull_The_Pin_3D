...
namespace CW.Common
{
	...
	public class CwInputManager : MonoBehaviour
	{
		...
		public static bool PointOverGui([Bridge.Ref] Vector2 screenPosition, int guiLayers = 1 << 5)
		{
		...
		public static List<RaycastResult> RaycastGui([Bridge.Ref] Vector2 screenPosition, int guiLayers = 1 << 5)
		{
		...
		private void AddFinger(int index, [Bridge.Ref] Vector2 screenPosition, float pressure, bool up)
		{
		...
		private static Vector2 Hermite([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b, [Bridge.Ref] Vector2 c, [Bridge.Ref] Vector2 d, float t)
		{
			var mu2 = t * t;
			var mu3 = mu2 * t;
		...
		private static float GetRadians([Bridge.Ref] Vector2 screenPosition, [Bridge.Ref] Vector2 referencePoint)
		{
			return Mathf.Atan2(screenPosition.x - referencePoint.x, screenPosition.y - referencePoint.y);
		}

		private static float GetDeltaRadians(Finger finger, [Bridge.Ref] Vector2 referencePoint, [Bridge.Ref] Vector2 lastReferencePoint)
		{
