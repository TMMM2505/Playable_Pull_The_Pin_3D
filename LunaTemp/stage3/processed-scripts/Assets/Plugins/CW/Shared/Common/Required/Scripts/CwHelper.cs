...
namespace CW.Common
{
	public static partial class CwHelper
	{
		...
		public static Color ToLinear([Bridge.Ref] Color gamma)
		{
		...
		public static Color ToGamma([Bridge.Ref] Color linear)
		{
			if (QualitySettings.activeColorSpace == ColorSpace.Linear)
			{
				return linear.gamma;
		...
		public static float UniformScale([Bridge.Ref] Vector3 scale)
		{
		...
		public static GameObject CreateGameObject(string name, int layer, Transform parent, [Bridge.Ref] Vector3 localPosition, [Bridge.Ref] Quaternion localRotation, [Bridge.Ref] Vector3 localScale, string recordUndo = null)
		{
		...
		public static float Atan2([Bridge.Ref] Vector2 xy)
		{
