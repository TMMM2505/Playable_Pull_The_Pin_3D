...
namespace Lean.Touch
{
	...
	public partial class LeanTouch : MonoBehaviour
	{
		...
		public static bool ElementOverlapped(GameObject element, [Bridge.Ref] Vector2 screenPosition)
		{
		...
		public static bool PointOverGui([Bridge.Ref] Vector2 screenPosition)
		{
		...
		public static List<RaycastResult> RaycastGui([Bridge.Ref] Vector2 screenPosition)
		{
		...
		/// NOTE: The first result (0) will be the top UI element that was first hit.</summary>
		public static List<RaycastResult> RaycastGui([Bridge.Ref] Vector2 screenPosition, [Bridge.Ref] LayerMask layerMask)
		{
		...
		public static void SimulateTap([Bridge.Ref] Vector2 screenPosition, float pressure = 1.0f, int tapCount = 1)
		{
			if (OnFingerTap != null)
			{
		...
		public LeanFinger AddFinger(int index, [Bridge.Ref] Vector2 screenPosition, float pressure, bool set)
		{
