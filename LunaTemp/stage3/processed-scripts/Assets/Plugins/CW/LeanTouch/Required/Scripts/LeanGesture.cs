...
namespace Lean.Touch
{
	...
	public static class LeanGesture
	{
		...
		/// <summary>Gets the average ScreenPosition distance between the fingers.</summary>
		public static float GetScreenDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center)
		{
			var distance = default(float); TryGetScreenDistance(fingers, center, ref distance); return distance;
		}

		/// <summary>Gets the average ScreenPosition distance between the fingers.</summary>
		public static bool TryGetScreenDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, ref float distance)
		{
			if (fingers != null)
			{
				var total = 0.0f;
		...
		/// <summary>Gets the average ScreenPosition distance * LeanTouch.ScalingFactor between the fingers.</summary>
		public static float GetScaledDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center)
		{
			return GetScreenDistance(fingers, center) * LeanTouch.ScalingFactor;
		}

		/// <summary>Gets the average ScreenPosition distance * LeanTouch.ScalingFactor between the fingers.</summary>
		public static bool TryGetScaledDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, ref float distance)
		{
		...
		/// <summary>Gets the last average ScreenPosition distance between all fingers.</summary>
		public static float GetLastScreenDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center)
		{
			var distance = default(float); TryGetLastScreenDistance(fingers, center, ref distance); return distance;
		}

		/// <summary>Gets the last average ScreenPosition distance between all fingers.</summary>
		public static bool TryGetLastScreenDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, ref float distance)
		{
			if (fingers != null)
			{
				var total = 0.0f;
		...
		/// <summary>Gets the last average ScreenPosition distance * LeanTouch.ScalingFactor between all fingers.</summary>
		public static float GetLastScaledDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center)
		{
			return GetLastScreenDistance(fingers, center) * LeanTouch.ScalingFactor;
		}

		/// <summary>Gets the last average ScreenPosition distance * LeanTouch.ScalingFactor between all fingers.</summary>
		public static bool TryGetLastScaledDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, ref float distance)
		{
		...
		/// <summary>Gets the start average ScreenPosition distance between all fingers.</summary>
		public static float GetStartScreenDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center)
		{
			var distance = default(float); TryGetStartScreenDistance(fingers, center, ref distance); return distance;
		}

		/// <summary>Gets the start average ScreenPosition distance between all fingers.</summary>
		public static bool TryGetStartScreenDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, ref float distance)
		{
			if (fingers != null)
			{
				var total = 0.0f;
		...
		/// <summary>Gets the start average ScreenPosition distance * LeanTouch.ScalingFactor between all fingers.</summary>
		public static float GetStartScaledDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center)
		{
			return GetStartScreenDistance(fingers, center) * LeanTouch.ScalingFactor;
		}

		/// <summary>Gets the start average ScreenPosition distance * LeanTouch.ScalingFactor between all fingers.</summary>
		public static bool TryGetStartScaledDistance(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, ref float distance)
		{
		...
		/// <summary>Gets the pinch scale of the fingers.</summary>
		public static bool TryGetPinchScale(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, [Bridge.Ref] Vector2 lastCenter, ref float scale, float wheelSensitivity = 0.0f)
		{
		...
		/// <summary>Gets the pinch ratio of the fingers (reciprocal of pinch scale).</summary>
		public static bool TryGetPinchRatio(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, [Bridge.Ref] Vector2 lastCenter, ref float ratio, float wheelSensitivity = 0.0f)
		{
			var distance     = GetScreenDistance(fingers, center);
			var lastDistance = GetLastScreenDistance(fingers, lastCenter);
		...
		/// <summary>Gets the average twist of the fingers in degrees.</summary>
		public static float GetTwistDegrees(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, [Bridge.Ref] Vector2 lastCenter)
		{
			return GetTwistRadians(fingers, center, lastCenter) * Mathf.Rad2Deg;
		}

		/// <summary>Gets the average twist of the fingers in degrees.</summary>
		public static bool TryGetTwistDegrees(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, [Bridge.Ref] Vector2 lastCenter, ref float degrees)
		{
		...
		/// <summary>Gets the average twist of the fingers in radians.</summary>
		public static float GetTwistRadians(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, [Bridge.Ref] Vector2 lastCenter)
		{
			var radians = default(float); TryGetTwistRadians(fingers, center, lastCenter, ref radians); return radians;
		}

		/// <summary>Gets the average twist of the fingers in radians.</summary>
		public static bool TryGetTwistRadians(List<LeanFinger> fingers, [Bridge.Ref] Vector2 center, [Bridge.Ref] Vector2 lastCenter, ref float radians)
		{
			if (fingers != null)
			{
				var total = 0.0f;
