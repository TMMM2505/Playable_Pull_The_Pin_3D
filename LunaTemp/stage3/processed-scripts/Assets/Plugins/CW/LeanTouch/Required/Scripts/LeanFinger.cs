...
namespace Lean.Touch
{
	...
	public class LeanFinger
	{
		...
		public float GetRadians([Bridge.Ref] Vector2 referencePoint)
		{
			return Mathf.Atan2(ScreenPosition.x - referencePoint.x, ScreenPosition.y - referencePoint.y);
		}

		/// <summary>This will return the angle between the finger and the reference point, relative to the screen.</summary>
		public float GetDegrees([Bridge.Ref] Vector2 referencePoint)
		{
		...
		public float GetLastRadians([Bridge.Ref] Vector2 referencePoint)
		{
			return Mathf.Atan2(LastScreenPosition.x - referencePoint.x, LastScreenPosition.y - referencePoint.y);
		}

		/// <summary>This will return the angle between the last finger position and the reference point, relative to the screen.</summary>
		public float GetLastDegrees([Bridge.Ref] Vector2 referencePoint)
		{
		...
		public float GetDeltaRadians([Bridge.Ref] Vector2 referencePoint)
		{
		...
		public float GetDeltaRadians([Bridge.Ref] Vector2 referencePoint, [Bridge.Ref] Vector2 lastReferencePoint)
		{
		...
		/// <summary>This will return the delta angle between the last and current finger position relative to the reference point.</summary>
		public float GetDeltaDegrees([Bridge.Ref] Vector2 referencePoint)
		{
			return GetDeltaRadians(referencePoint, referencePoint) * Mathf.Rad2Deg;
		}

		/// <summary>This will return the delta angle between the last and current finger position relative to the reference point and the last reference point.</summary>
		public float GetDeltaDegrees([Bridge.Ref] Vector2 referencePoint, [Bridge.Ref] Vector2 lastReferencePoint)
		{
		...
		public float GetScreenDistance([Bridge.Ref] Vector2 point)
		{
		...
		public float GetScaledDistance([Bridge.Ref] Vector2 point)
		{
		...
		public float GetLastScreenDistance([Bridge.Ref] Vector2 point)
		{
		...
		public float GetLastScaledDistance([Bridge.Ref] Vector2 point)
		{
		...
		public float GetStartScreenDistance([Bridge.Ref] Vector2 point)
		{
		...
		public float GetStartScaledDistance([Bridge.Ref] Vector2 point)
		{
