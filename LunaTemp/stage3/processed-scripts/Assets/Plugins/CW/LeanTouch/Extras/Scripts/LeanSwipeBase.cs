...
namespace Lean.Touch
{
	...
	public abstract class LeanSwipeBase : MonoBehaviour
	{
		...
		protected bool AngleIsValid([Bridge.Ref] Vector2 vector)
		{
			if (requiredArc >= 0.0f)
			{
		...
		protected void HandleFingerSwipe(LeanFinger finger, [Bridge.Ref] Vector2 screenFrom, [Bridge.Ref] Vector2 screenTo)
		{
