...
namespace Lean.Common
{
	...
	public struct LeanScreenQuery
	{
		...
		public T Query<T>(GameObject gameObject, [Bridge.Ref] Vector2 screenPosition)
		{
		...
		public bool TryQuery<T>(GameObject gameObject, [Bridge.Ref] Vector2 screenPosition, ref T result, ref Component root, ref Vector3 worldPosition)
		{
		...
		private void DoRaycast3D(Camera camera, [Bridge.Ref] Vector2 screenPosition, ref Component bestResult, ref float bestDistance, ref Vector3 bestPosition)
		{
		...
		private void DoRaycast2D(Camera camera, [Bridge.Ref] Vector2 screenPosition, ref Component bestResult, ref float bestDistance, ref Vector3 bestPosition)
		{
			var ray   = camera.ScreenPointToRay(screenPosition);
		...
		private void DoRaycastUI([Bridge.Ref] Vector2 screenPosition, ref Component bestResult, ref float bestDistance, ref Vector3 bestPosition)
		{
