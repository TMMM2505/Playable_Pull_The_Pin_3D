...
namespace Lean.Common
{
	...
	public class LeanThresholdPosition : MonoBehaviour
	{
		...
		public void AddXY([Bridge.Ref] Vector2 delta)
		{
			Current.x += delta.x;
			Current.y += delta.y;
		}
		...
		/// <summary>This method allows you to increment <b>Current</b>.</summary>
		public void AddXYZ([Bridge.Ref] Vector3 delta)
		{
			Current += delta;
		}
		...
		public void SetXY([Bridge.Ref] Vector2 position)
		{
		...
		/// <summary>This method allows you to set the <b>Current</b> position.</summary>
		public void SetXYZ([Bridge.Ref] Vector3 position)
		{
			Current = position;
		}
