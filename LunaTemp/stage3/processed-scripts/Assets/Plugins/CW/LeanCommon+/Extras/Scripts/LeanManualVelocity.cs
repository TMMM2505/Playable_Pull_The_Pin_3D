...
namespace Lean.Common
{
	...
	public class LeanManualVelocity : MonoBehaviour
	{
		...
		public void AddForceAB([Bridge.Ref] Vector2 delta)
		{
			AddForce(directionA * delta.x + directionB * delta.y);
		}

		public void AddForceFromTo([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to)
		{
			AddForce(to - from);
		}

		public void AddForce([Bridge.Ref] Vector3 delta)
		{
