...
namespace Lean.Common
{
	...
	public class LeanManualTorque : MonoBehaviour
	{
		...
		public void AddTorqueAB([Bridge.Ref] Vector2 delta)
		{
			AddTorque(axisA * delta.x + axisB * delta.y);
		}

		public void AddTorqueFromTo([Bridge.Ref] Vector3 from, [Bridge.Ref] Vector3 to)
		{
			AddTorque(to - from);
		}

		public void AddTorque([Bridge.Ref] Vector3 delta)
		{
