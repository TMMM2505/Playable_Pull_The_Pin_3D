...
namespace Lean.Common
{
	...
	public class LeanValue : MonoBehaviour
	{
		...
		public void SetXY([Bridge.Ref] Vector2 xy) { current.x = xy.x; current.y = xy.y; Submit(); }
		public void SetXYZ([Bridge.Ref] Vector3 xyz) { current = xyz; Submit(); }

		public void SetX(int x) { SetX(x); }
		public void SetY(int y) { SetY(y); }
		public void SetZ(int z) { SetZ(z); }
		public void SetXY([Bridge.Ref] Vector2Int xy) { SetXY(xy); }
		public void SetXYZ([Bridge.Ref] Vector3Int xyz) { SetXYZ(xyz); }
		...
		public void IncXY([Bridge.Ref] Vector2 v) { SetXY((Vector2)current + v); }
		public void IncXYZ([Bridge.Ref] Vector3 v) { SetXY(current + v); }

		public void IncX(int v) { SetX(current.x + v); }
		public void IncY(int v) { SetY(current.x + v); }
		public void IncZ(int v) { SetZ(current.x + v); }
		public void IncXY([Bridge.Ref] Vector2Int v) { SetXY((Vector2)current + v); }
		public void IncXYZ([Bridge.Ref] Vector3Int v) { SetXY(current + v); }
