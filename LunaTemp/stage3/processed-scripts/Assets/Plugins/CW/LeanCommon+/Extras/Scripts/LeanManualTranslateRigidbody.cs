...
namespace Lean.Common
{
	...
	public class LeanManualTranslateRigidbody : MonoBehaviour
	{
		...
		public void TranslateAB([Bridge.Ref] Vector2 magnitude)
		{
		...
		public void Translate([Bridge.Ref] Vector3 vector)
		{
		...
		public void TranslateWorld([Bridge.Ref] Vector3 vector)
		{
			if (scaleByTime == true)
			{
