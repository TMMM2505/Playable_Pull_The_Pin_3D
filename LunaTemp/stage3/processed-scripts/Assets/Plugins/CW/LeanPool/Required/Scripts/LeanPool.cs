...
namespace Lean.Pool
{
	...
	public static class LeanPool
	{
		...
		/// <summary>This allows you to spawn a prefab via Component.</summary>
		public static T Spawn<T>(T prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null)
			where T : Component
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
		...
		/// <summary>This allows you to spawn a prefab via GameObject.</summary>
		public static GameObject Spawn(GameObject prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null)
		{
			if (prefab == null) { Debug.LogError("Attempting to spawn a null prefab."); return null; }
			if (parent != null)
			{
		...
		/// <summary>This allows you to spawn a prefab via GameObject.</summary>
		private static GameObject Spawn(GameObject prefab, [Bridge.Ref] Vector3 localPosition, [Bridge.Ref] Quaternion localRotation, [Bridge.Ref] Vector3 localScale, Transform parent, bool worldPositionStays)
		{
			if (prefab != null)
			{
