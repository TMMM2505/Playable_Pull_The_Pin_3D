...
namespace Lean.Pool
{
	...
	public class LeanGameObjectPool : MonoBehaviour, ISerializationCallbackReceiver
	{
		...
		/// <summary>This will either spawn a previously despawned/preloaded clone, recycle one, create a new one, or return null.
		/// NOTE: This method is designed to work with Unity's event system, so it has no return value.</summary>
		public void Spawn([Bridge.Ref] Vector3 position)
		{
		...
		/// <summary>This will either spawn a previously despawned/preloaded clone, recycle one, create a new one, or return null.</summary>
		public GameObject Spawn([Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null)
		{
		...
		/// <summary>This will either spawn a previously despawned/preloaded clone, recycle one, create a new one, or return null.</summary>
		public bool TrySpawn(ref GameObject clone, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null)
		{
			if (prefab == null) { if (warnings == true) Debug.LogWarning("You're attempting to spawn from a pool with a null prefab", this); return false; }
			if (parent != null)
			{
		...
		/// <summary>This will either spawn a previously despawned/preloaded clone, recycle one, create a new one, or return null.</summary>
		public bool TrySpawn(ref GameObject clone, [Bridge.Ref] Vector3 localPosition, [Bridge.Ref] Quaternion localRotation, [Bridge.Ref] Vector3 localScale, Transform parent, bool worldPositionStays)
		{
			if (prefab != null)
			{
		...
		private GameObject CreateClone([Bridge.Ref] Vector3 localPosition, [Bridge.Ref] Quaternion localRotation, [Bridge.Ref] Vector3 localScale, Transform parent, bool worldPositionStays)
		{
		...
		private GameObject DoInstantiate(GameObject prefab, [Bridge.Ref] Vector3 localPosition, [Bridge.Ref] Quaternion localRotation, [Bridge.Ref] Vector3 localScale, Transform parent, bool worldPositionStays)
		{
#if UNITY_EDITOR
		...
		private void SpawnClone(GameObject clone, [Bridge.Ref] Vector3 localPosition, [Bridge.Ref] Quaternion localRotation, [Bridge.Ref] Vector3 localScale, Transform parent, bool worldPositionStays)
		{
			// Register
			if (recycle == true)
			{
