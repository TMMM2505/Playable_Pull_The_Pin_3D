...
namespace Animancer
{
    ...
    public class DirectionalAnimationSet8 : DirectionalAnimationSet
    {
        ...
        public override AnimationClip GetClip([Bridge.Ref] Vector2 direction)
        {
        ...
        public new static Direction VectorToDirection([Bridge.Ref] Vector2 vector)
        {
        ...
        public new static Vector2 SnapVectorToDirection([Bridge.Ref] Vector2 vector)
        {
