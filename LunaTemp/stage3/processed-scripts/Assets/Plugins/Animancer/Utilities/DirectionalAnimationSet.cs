...
namespace Animancer
{
    ...
    public class DirectionalAnimationSet : ScriptableObject, IAnimationClipSource
    {
        ...
        public virtual AnimationClip GetClip([Bridge.Ref] Vector2 direction)
        {
            if (direction.x >= 0)
            {
                if (direction.y >= 0)
        ...
        public static Direction VectorToDirection([Bridge.Ref] Vector2 vector)
        {
            if (vector.x >= 0)
            {
                if (vector.y >= 0)
        ...
        public static Vector2 SnapVectorToDirection([Bridge.Ref] Vector2 vector)
        {
