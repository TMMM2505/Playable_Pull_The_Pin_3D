...
namespace Animancer
{
    ...
    public class DirectionalMixerState : MixerState<Vector2>
    {
        ...
        private static float SignedAngle([Bridge.Ref] Vector2 a, [Bridge.Ref] Vector2 b)
        {
        ...
        /// <inheritdoc/>
        public override void AppendParameter(StringBuilder text, [Bridge.Ref] Vector2 parameter)
        {
            text.Append('(')
                .Append(parameter.x)
                .Append(", ")
