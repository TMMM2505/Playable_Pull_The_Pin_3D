...
namespace Animancer
{
        ...
        IEnumerator, IPlayableWrapper, IAnimationClipCollection
    {
        ...
        public override void OnPlayableCreate([Bridge.Ref] Playable playable)
        {
        ...
        /// </summary>
        public void InsertOutputPlayable([Bridge.Ref] Playable playable)
        {
            var output = _Graph.GetOutput(0);
        ...
        public override void OnPlayableDestroy([Bridge.Ref] Playable playable)
        {
        ...
        /// </remarks>
        public AnimancerState Play(AnimationClip clip, float fadeDuration, FadeMode mode = default(Animancer.FadeMode))
        ...
        /// <em>Animancer Lite only allows the default `fadeDuration` (0.25 seconds) in runtime builds.</em>
        /// </remarks>
        public AnimancerState Play(AnimancerState state, float fadeDuration, FadeMode mode = default(Animancer.FadeMode))
        {
            var layer = state.Layer ?? Layers[0];
        ...
        /// This method is safe to call repeatedly without checking whether the `transition` was already playing.
        /// </remarks>
        public AnimancerState Play(ITransition transition, float fadeDuration, FadeMode mode = default(Animancer.FadeMode))
        {
        ...
        /// </remarks>
        /// <exception cref="ArgumentNullException">The `key` is null.</exception>
        public AnimancerState TryPlay(object key, float fadeDuration, FadeMode mode = default(Animancer.FadeMode))
        ...
        /// </remarks>
        public override void PrepareFrame([Bridge.Ref] Playable playable, [Bridge.Ref] FrameData info)
        {
#if UNITY_ASSERTIONS
