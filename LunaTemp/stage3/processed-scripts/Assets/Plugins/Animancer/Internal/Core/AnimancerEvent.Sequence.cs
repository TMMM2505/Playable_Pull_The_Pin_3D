...
namespace Animancer
{
    partial struct AnimancerEvent
    {
        ...
        public partial class Sequence : IEnumerable<AnimancerEvent>
        {
            ...
            /// <summary>[Pro-Only] Returns the index of the `animancerEvent` or <c>-1</c> if there is no such event.</summary>
            /// <seealso cref="IndexOfRequired(int, AnimancerEvent)"/>
            public int IndexOf(int indexHint, [Bridge.Ref] AnimancerEvent animancerEvent)
            {
                if (Count == 0)
                    return -1;
            ...
            public int IndexOfRequired(int indexHint, [Bridge.Ref] AnimancerEvent animancerEvent)
            {
            ...
            public int Add([Bridge.Ref] AnimancerEvent animancerEvent)
            {
#if UNITY_ASSERTIONS
            ...
            /// <exception cref="ArgumentNullException">Use the <see cref="DummyCallback"/> instead of <c>null</c>.</exception>
            /// <seealso cref="OptionalWarning.DuplicateEvent"/>
            public int Add(int indexHint, [Bridge.Ref] AnimancerEvent animancerEvent)
            {
#if UNITY_ASSERTIONS
                if (animancerEvent.callback == null)
                    throw new ArgumentNullException($"{nameof(AnimancerEvent)}.{nameof(callback)}", NullCallbackError);
            ...
            /// </summary>
            [System.Diagnostics.Conditional(Strings.Assertions)]
            private void AssertEventUniqueness(int index, [Bridge.Ref] AnimancerEvent newEvent)
            {
#if UNITY_ASSERTIONS
            ...
            public void Remove(int index)
            {
                ...
                if (index < Count)
                {
                    ...
                    if (_Names != null)
                    {
                        ...
                        _Names[nameCount - 1] = default(string);
                    }
                }
                else if (_Names != null && index < _Names.Length)
                {
                    _Names[index] = default(string);
                }

                _Events[Count] = default(Animancer.AnimancerEvent);
                Version++;
            }
            ...
            /// </summary>
            public bool Remove([Bridge.Ref] AnimancerEvent animancerEvent)
            {
            ...
            public void CopyFrom(Sequence source)
            {
                if (source == null)
                {
                    ...
                    Count = 0;
                    Capacity = 0;
                    endEvent = default(Animancer.AnimancerEvent);
                    return;
                }
