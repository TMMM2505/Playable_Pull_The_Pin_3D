...
namespace Odeeo
{
    public class OdeeoAdManager : MonoBehaviour
    {
        ...
        public static void SetAudioOnlyBackground(string placementID, [Bridge.Ref] Color color)
        {
            if (!s_adUnits.ContainsKey(placementID))
            {
        ...
        public static void SetAudioOnlyAnimation(string placementID, [Bridge.Ref] Color color)
        {
            if (!s_adUnits.ContainsKey(placementID))
            {
        ...
        public static void SetProgressBar(string placementID, [Bridge.Ref] Color progressBarColor)
        {
            if (!s_adUnits.ContainsKey(placementID))
            {
