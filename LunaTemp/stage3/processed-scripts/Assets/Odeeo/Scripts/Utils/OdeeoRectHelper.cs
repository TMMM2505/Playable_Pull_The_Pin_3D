...
namespace Odeeo.Utils
{
    internal static class OdeeoRectHelper
    {
        ...
        internal static Vector2 ConvertRectToPosition([Bridge.Ref] Rect rect, OdeeoSdk.IconPosition iconPosition, int size)
        {
        ...
        internal static Vector2 PixelPositionToDp([Bridge.Ref] Vector2 pos)
        {
            return pos / OdeeoSdk.GetDeviceScale();
        }
    }
}