...
namespace Odeeo
{
    ...
    public class OdeeoIconAnchor : UIBehaviour
    {
        ...
        {
            string errorMessage = message + "Put IconAnchor in Canvas";
            OdeeoSdk.LogE(OdeeoSdk.LogLevel.Debug, errorMessage);
        }

        private OdeeoSdk.IconPosition GetClosest([Bridge.Ref] Vector3 startPosition, Dictionary<OdeeoSdk.IconPosition, Vector3> pickups)
        {
        ...
        private void CalculateScreenSize()
        {
            ...
            float minScreenSize = 70f * OdeeoSdk.GetDeviceScale();
            float maxScreenSize = 120f * OdeeoSdk.GetDeviceScale();
