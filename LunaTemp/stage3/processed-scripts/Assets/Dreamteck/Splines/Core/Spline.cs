...
namespace Dreamteck.Splines {
    ...
    public class Spline {
       ...
       public int iterations
        ...
        /// <returns></returns>
        public double Project([Bridge.Ref] Vector3 position, int subdivide = 4, double from = 0.0, double to = 1.0)
        {
        ...
        private double GetClosestPoint(int iterations, [Bridge.Ref] Vector3 point, double start, double end, int slices)
        {
            if (iterations <= 0)
            {
