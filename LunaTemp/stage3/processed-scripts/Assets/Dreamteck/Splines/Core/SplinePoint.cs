...
namespace Dreamteck.Splines{
	...
	public struct SplinePoint {
        ...
        private bool EqualsFast([Bridge.Ref] SplinePoint obj)
        {
        ...
        public void SetPosition([Bridge.Ref] Vector3 pos)
        {
        ...
        public void SetTangentPosition([Bridge.Ref] Vector3 pos)
        {
            tangent = pos;
            switch (_type)
            {
        ...
        public void SetTangent2Position([Bridge.Ref] Vector3 pos)
        {
            tangent2 = pos;
            switch (_type)
            {
