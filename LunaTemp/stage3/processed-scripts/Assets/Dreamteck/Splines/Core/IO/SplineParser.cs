...
namespace Dreamteck.Splines.IO
{
    public class SplineParser 
    {
        ...
        internal class SplineDefinition
        {
            ...
            internal void SetLastPoint([Bridge.Ref] SplinePoint point)
            {
            ...
            internal SplineComputer CreateSplineComputer([Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
            {
